...
export default function Pinfinger() {
  ...
  function generate() {
    setGameState({ ...gameState, phase: 'wait' });
  }
    ...
    <Container>
      ...
      {(phase === 'create' && (
        <div style={{ textAlign: 'left', padding: '0 20px', fontSize: '14px' }}>
          ...
          <br />
          2 - press generate link, share it with your algofriend
          <br />
          3 - wait for him to access and deposit, deposit the amount too.. in
          the first round you choose a sequence that your opponent must do,
          after that, the time it takes to solve sequence will be counted then
          it`s his turn to choose the sequence, whoever takes the shortest time
          wins the round
          <br />4 - there are a total of 3 rounds, at the end the winner takes
          the deposited prize
          <div>
            <br />
            bet: <input type="number" /> ALG
          </div>
          <br />
